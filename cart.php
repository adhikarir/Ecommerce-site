			...
			while($pp_price=mysqli_fetch_array($run_pro_price)){
				...
				$total +=$values;
					 ...
					 <tr align="center">
					 	...
					 	<td><?php echo $product_title; ?><br><img src="admin_area/product_image/<?php echo $product_image; ?>" width="60" height="60"/></td>
					...
					foreach ($_POST['remove'] as $remove_id) {
						...
						if($run_delete){
							echo "<script>window.open('cart.php','_self') </script>";
								echo "<script>alert('Are you Sure to DELETE this!')</script>";
